...
public class ChatReaction {
    ...
    public ReactionType getReactionType() {return this.reactionType;}

    public Pinata getPinata() {return this.pinata;}

    public void setReactionType(ReactionType reactionType) {this.reactionType = reactionType; }

    public void setPinata(Pinata pinata) {this.pinata = pinata; }
    ...
    protected boolean canEqual(Object other) {return other instanceof ChatReaction;}

    public String toString() {return "ChatReaction(reactionType=" + this.getReactionType() + ", pinata=" + this.getPinata() + ")";}
